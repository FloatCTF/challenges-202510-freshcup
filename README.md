...
| caesar            | Crypto  | myx2727461997@gmail.com | 凯撒大帝的秘密信息！ 密文：iordwfwi{fdhvdu_flskhu_lv_hdvb} 提示 1：这是最古老的加密方法之一 提示 2：凯撒密码的位移量通常在 1-25 之间 提示 3：试试往回移动 3 位 |
| png               | Misc    | fb0sh@outlook.com       | 图片里面有什么                                                                                                                                                 |
| easy_reverse      | Reverse | ablklice@gmail.com      | 使用 tea 算法进行解密,答案使用 flag{}进行包裹                                                                                                                  |
| strings_attached1 | Reverse | ablklice@gmail.com      | 找到了一串字符串，要用什么算法解密呢                                                                                                                           |
| strings_attached2 | Reverse | ablklice@gmail.com      | 和 strings_attached1 加密算法一样，但好像又有一些不同                                                                                                          |
